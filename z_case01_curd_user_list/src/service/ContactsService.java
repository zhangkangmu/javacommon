...
public class ContactsService {
    ...
    public ContactPage searchContact(SearchContact searchContact, int pageNumber, int pagesize) throws SQLException {
        List<Contact> contacts = contactsDao.searchContact(searchContact,pageNumber,pagesize);
        //总数
        int count =contacts.size()+1;
        ContactPage contactPage = getContactPage(count,pageNumber, pagesize, contacts);
        return contactPage;
    }
